...
public class TestControls {
    ...
    public void testAutoStartPoseFlip() {
        ...
        assertEquals(path1.getPreviewStartingHolonomicPose().getTranslation(),  m_controls.getStartPose().getTranslation());
        ...
        assertEquals(flippedPath.getPreviewStartingHolonomicPose().getTranslation(),  m_controls.getStartPose().getTranslation());
    }
}
