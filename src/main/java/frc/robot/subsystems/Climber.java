...
public class Climber extends SubsystemBase {
  ...
  public MechanismLigament2d hook1Ligament2d =
      climberLigament2d.append(new MechanismLigament2d("Hook 1", 0.1, -90));
  public MechanismLigament2d hook2Ligament2d =
      hook1Ligament2d.append(new MechanismLigament2d("Hook 2", 0.1, -90));
