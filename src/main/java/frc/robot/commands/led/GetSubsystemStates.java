...
//     // highest priority
//     if (isIntaking) {
//       m_led.expressState(LED.SUBSYSTEM_STATES.STROBE);
//     } else if (isReved) {
//       m_led.expressState(LED.SUBSYSTEM_STATES.SOLID);
//     } else if (isUnreved) {
//       m_led.expressState(LED.SUBSYSTEM_STATES.COLORFLOW);
//     } else if (isClimbing) {
//       m_led.expressState(LED.SUBSYSTEM_STATES.CLIMBING);
//     } else if (isEnabled) {
//       m_led.expressState(LED.SUBSYSTEM_STATES.FIRE);
//     } else if (isSetup) {
