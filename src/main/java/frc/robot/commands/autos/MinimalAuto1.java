...
public class MinimalAuto1 extends SequentialCommandGroup {
  /** Creates a new DriveStraightTest. */
  public MinimalAuto1(CommandSwerveDrivetrain swerveDrive) {

    PathPlannerPath path = PathPlannerPath.fromPathFile("MinimalAuto1");
