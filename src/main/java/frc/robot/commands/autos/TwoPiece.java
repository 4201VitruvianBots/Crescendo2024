...
public class TwoPiece extends SequentialCommandGroup {
  ...
  public TwoPiece(
    ...
    var RunIntake =
        new AutoRunIntake(
            intake, STATE.FRONT_ROLLER_INTAKING.get(), STATE.BACK_ROLLER_INTAKING.get());
  var RunIntake2 =
        new AutoRunIntake(
            intake, STATE.FRONT_ROLLER_INTAKING.get(), STATE.BACK_ROLLER_INTAKING.get());
    ...
    var flywheelCommandContunues = new AutoSetRPMSetpoint(shooter, RPM_SETPOINT.MAX.get());

    addCommands(
        new PlotAutoPath(fieldSim, "3Piece2Pt1", pathsList),
