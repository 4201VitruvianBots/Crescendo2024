...
public class ShooterVisualizer {
  ...
  public ShooterVisualizer(String name, MechanismRoot2d root2d) {
    ...
    m_side2 =
        m_side1.append(
            new MechanismLigament2d("side2", SHOOTER.flywheelSize, 45, 3, new Color8Bit(Color.kDimGray)));
    m_side3 =
        m_side2.append(
            new MechanismLigament2d("side3", SHOOTER.flywheelSize, 45, 3, new Color8Bit(Color.kDimGray)));
    m_side4 =
        m_side3.append(
            new MechanismLigament2d("side4", SHOOTER.flywheelSize, 45, 3, new Color8Bit(Color.kDimGray)));
    m_side5 =
        m_side4.append(
            new MechanismLigament2d("side5", SHOOTER.flywheelSize, 45, 3, new Color8Bit(Color.kDimGray)));
    m_side6 =
        m_side5.append(
            new MechanismLigament2d("side6", SHOOTER.flywheelSize, 45, 3, new Color8Bit(Color.kDimGray)));
    m_side7 =
        m_side6.append(
            new MechanismLigament2d("side7", SHOOTER.flywheelSize, 45, 3, new Color8Bit(Color.kDimGray)));
    m_side8 =
        m_side7.append(
  ...
  public MechanismLigament2d[] getSideLigaments() {
    return new MechanismLigament2d[] {m_side1, m_side2, m_side3, m_side4, m_side5, m_side6, m_side7, m_side8};
  }
  
  public void update(double rpm) {
    if (m_spinner != null) {
        m_spinner.setAngle(
            m_spinner.getAngle() - 360 * rpm / 60 * 0.2);
    } else {
